...
---@field offset Vector2 # Camera offset (screen space offset from window origin)
---@field target Vector2 # Camera target (world space target point that is mapped to screen space offset)
...
---@field boneCount number # Number of bones (MAX: 256 bones)
---@field boneIndices string|lightuserdata # Vertex bone indices, up to 4 bones influence by vertex (skinning) (shader-location = 6)
...
local BoneInfo = {}
---@class ModelSkeleton @ Skeleton, animation bones hierarchy
---@alias ModelSkeleton_ptr ModelSkeleton
---@alias ModelSkeleton_ptr_ptr ModelSkeleton
---@field boneCount number # Number of bones
---@field bones BoneInfo_ptr|lightuserdata # Bones information (skeleton)
---@field bindPose ModelAnimPose # Bones base transformation (Transform[])
---Constructed using `rl.new("ModelSkeleton", ...)`
local ModelSkeleton = {}
...
---@field currentPose ModelAnimPose # Current animation pose (Transform[])
---@field boneMatrices Matrix_ptr|lightuserdata # Bones animated transformation matrices
---Constructed using `rl.new("Model", ...)`
local Model = {}
---@class ModelAnimation @ ModelAnimation, contains a full animation sequence
...
---@field boneCount number # Number of bones (per pose)
---@field keyframeCount number # Number of animation key frames
---@field keyframePoses ModelAnimPose_ptr|lightuserdata # Animation sequence keyframe poses [keyframe][pose]
...
---@param fileName string|lightuserdata
---@param fileRename string|lightuserdata
---@return number
...
---@param srcPath string|lightuserdata
---@param dstPath string|lightuserdata
---@return number
...
---@param fileName string|lightuserdata
---@param search string|lightuserdata
---@param replacement string|lightuserdata
---@return number
...
---@param points const_Vector2_ptr|lightuserdata
...
---@param text string|lightuserdata
---@param begin string|lightuserdata
---@param end_ string|lightuserdata
---@return string|lightuserdata
...
---@param points const_Vector3_ptr|lightuserdata
---@param pointCount number
---@param color Color
---Draw a triangle strip defined by points
...
---@field vertices number # Vertex position (XYZ - 3 components per vertex) (shader-location = 0)
---@field texcoords number # Vertex texture coordinates (UV - 2 components per vertex) (shader-location = 1)
---@field normals number # Vertex normal (XYZ - 3 components per vertex) (shader-location = 2)
---@field colors string|lightuserdata # Vertex colors (RGBA - 4 components per vertex) (shader-location = 3)
...
---@field vboId #if_defined(GRAPHICS_API_OPENGL_ES2)[5] # OpenGL Vertex Buffer Objects id (5 types of vertex data)
---@field indices unsigned_short_ptr|lightuserdata # Vertex indices (in case vertex data comes indexed) (6 indices per quad)
---@field colors #endif # Vertex colors (RGBA - 4 components per vertex) (shader-location = 3)
---@field vaoId number # OpenGL Vertex Array Object id
---@field vboId number # OpenGL Vertex Buffer Objects id (5 types of vertex data)
...
function rl.rlBlitFramebuffer(srcX,srcY,srcWidth,srcHeight,dstX,dstY,dstWidth,dstHeight,bufferMask) end
---@param target number
...
function rl.rlSetPointSize(size) end
---@return number
...
---@param procName string|lightuserdata
---@return string|lightuserdata
---Get OpenGL procedure address
function rl.rlGetProcAddress(procName) end
---@return number
...
function rl.rlFramebufferAttach(id,texId,attachType,texType,mipLevel) end
---@param id number
---@return bool
...
function rl.rlCopyFramebuffer(x,y,width,height,format,pixels) end
---@param width number
---@param height number
---Resize internal framebuffer
function rl.rlResizeFramebuffer(width,height) end
---@param code string|lightuserdata
---@param type number
---@return number
...
function rl.rlLoadShaderProgramEx(vsId,fsId) end
---@param csId number
---@return number
...
function rl.rlGetLocationUniform(id,uniformName) end
---@param id number
---@param attribName string|lightuserdata
---@return number
---Get shader location attribute, requires shader program id
function rl.rlGetLocationAttrib(id,attribName) end
---@param locIndex number
---@param value string|lightuserdata
---@param uniformType number
---@param count number
...
---@param locIndex number
---@param mat const_Matrix_ptr|lightuserdata
---@param count number
---Set shader value matrices
function rl.rlSetUniformMatrices(locIndex,mat,count) end
---@param locIndex number
...
function rl.rlUpdateShaderBuffer(id,data,dataSize,offset) end
---@param id number
---@param index number
---Bind SSBO buffer
...
function rl.rlReadShaderBuffer(id,dest,count,offset) end
---@param destId number
---@param srcId number
...
---@overload fun(t: '"ModelSkeleton"', ...): ModelSkeleton
